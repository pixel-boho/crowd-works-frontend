...
export class ApiService {
  ...
  // public BASE_URL = 'https://crowdworksindia.org/test/api/web/v1';
  // public BASE_URL = 'https://crowdworksindia.org/crowdworks/api/web/v1';
  public BASE_URL = 'https://pixelboho.space/crowdworks/api/web/v1';
  ...
  payout(data: any): Observable<any> {
    ...
    return this.http.post<any>(this.BASE_URL + `/razorpay/pay-out`, data, httpOptions1);
  }
  withdraw(data: any) {
    var loginToken = localStorage.getItem('LoginToken');
    var httpOptions1 = {
  ...
  sendeEmail() {
    ...
    return this.http.get<any>(this.BASE_URL + `/`, httpOptions1);
  }
  ...
  generatePdf() {
    ...
    return this.http.get<any>(this.BASE_URL + `/user/generate-pdf`);
  }
  //=============================================================// 

  paymentFetch(data: any) {
    var loginToken = localStorage.getItem('LoginToken');
    var httpOptions1 = {
      headers: new HttpHeaders({
        Authorization: 'Bearer ' + loginToken,
    ...
    return this.http.post<any>(this.BASE_URL + `/razorpay/fetch-payment`, data, httpOptions1);
  }
  //===================test/////////////////////////////
  ...
  Test() {
    ...
    // console.log(data)
    return this.http.post<any>(`https://crowdworksindia.org/test/api/web/v1/user/generate-pdf`, data);
  ...
  Receipt(data: any) {
    ...
    return this.http.post<any>(this.BASE_URL + `/user/generate-receipt`, data);
  }
  generatePdf1(data: any) {
    ...
    return this.http.post<any>(this.BASE_URL + `/user/generate-pdf`, data, httpOptions1);
  }
}
